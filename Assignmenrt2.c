    ...
    if(search_result != -1)
    {
        ...
        printf("Select an option: ");
            ...
            if(yesno == 1)
            {
                ...
                scanf("%s", &v[search_result].Vehicle_Manufacturer);
                printf("Update Vehicle name:");
                scanf("%s", &v[search_result].Vehicle_Name);
...
void addVehicle(vehicle_t *v, int availableSlot)
{
    if(availableSlot<50)
    {
        ...
        scanf("%s", &v[availableSlot].Vehicle_Manufacturer);
        printf("Enter Vehicle name:");
        scanf("%s", &v[availableSlot].Vehicle_Name);
    ...
    if(search_result != -1)
    {
        ...
        printf("Select an option: ");
            ...
            if(yesno == 1)
            {
                ...
                scanf("%s", &obs[search_result].Obstacle_name);
                printf("Update Obstacle texture(32 characters):");
                scanf("%s", &obs[search_result].Obstacle_texture);
...
void addObstacle(obstacle_t *obs, int availableSlot)
{
    if(availableSlot<50)
    {
        ...
        scanf("%s", &obs[availableSlot].Obstacle_name);
        printf("Enter Obstacle texture(32 characters):");
        scanf("%s", &obs[availableSlot].Obstacle_texture);
